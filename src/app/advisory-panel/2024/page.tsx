...
// export default function AdvisoryPanel2024Page() {
...
//       setIsLoading(true);
//       const data = await fetchWebsitePageBySlug('advisory-panel-2024');
//       setPage(data);
...
//         <br />
//         <h2>{page?.title || 'Advisory Panel 2024'}</h2>
//         <br />
//         <p>
  ...
  useEffect(() => {
    ...
    async function loadPage() {
      try {
        ...
        // console.error('Failed to load Advisory Panel 2024:', error);
