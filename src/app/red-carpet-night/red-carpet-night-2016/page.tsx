...
export default function RedCarpetNight2016Page() {
  ...
  useEffect(() => {
    async function loadPage() {
      try {
        const data = await fetchWebsitePageBySlug('red-carpet-night-2016');
    ...
    <main className="rcn-main">
      <section className="rcn-hero">
        ...
        <div className="rcn-hero-content">
          ...
          <h1 className="rcn-title">{page?.title || 'Red Carpet Night 2016'}</h1>
