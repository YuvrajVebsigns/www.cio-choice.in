...
export default function RedCarpetNight2014Page() {
  ...
  useEffect(() => {
    async function loadPage() {
      try {
        const data = await fetchWebsitePageBySlug('red-carpet-night-2014');
    ...
    <main className="rcn-main">
      <section className="rcn-hero">
        ...
        <div className="rcn-hero-content">
          ...
          <h1 className="rcn-title">{page?.title || 'Red Carpet Night 2014'}</h1>
