...
export const metadata = {
  title: 'Red Carpet Night 2023',
  description:
    'Celebrate Red Carpet Night 2023 with CIO Choice recognition and curated brand honors.',
};

export default function RedCarpetNight2023Page() {
  return (
    <main className="rcn-main">
      <section className="rcn-hero">
        ...
        <div className="rcn-hero-content">
          ...
          <h1 className="rcn-title">Red Carpet Night 2023</h1>
      ...
      <section className="rcn-cards-section">
        <div className="rcn-cards-grid">
          ...
          <article className="rcn-card">
            <h2>Yearly Honors</h2>
            <p>
              The 2023 edition celebrates innovation, trust, and customer excellence across the CIO
              ecosystem.
            </p>
          </article>
          <article className="rcn-card">
