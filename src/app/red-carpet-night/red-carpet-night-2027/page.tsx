...
// export default function RedCarpetNight2027Page() {
...
//       try {
//         const data = await fetchWebsitePageBySlug('red-carpet-night-2027');
...
//           <h1 className="rcn-title">{page?.title || 'Red Carpet Night 2027'}</h1>
  ...
  useEffect(() => {
    ...
    async function loadPage() {
      try {
        ...
        // console.error('Failed to load Red Carpet Night 2027:', error);
