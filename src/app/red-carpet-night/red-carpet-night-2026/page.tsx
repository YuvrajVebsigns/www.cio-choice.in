...
//       try {
//         const data = await fetchWebsitePageBySlug('red-carpet-night-2026');
...
//           <h1 className="rcn-title">{page?.title || 'Red Carpet Night 2026'}</h1>
  ...
  useEffect(() => {
    ...
    async function loadPage() {
      try {
        ...
        // console.error('Failed to load Red Carpet Night 2026:', error);
