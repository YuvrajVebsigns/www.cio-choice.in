...
export default function RedCarpetNight2026Page() {
  return (
    <main className="rcn-main">
      <section className="rcn-hero">
        ...
        <div className="rcn-hero-content">
          ...
          <h1 className="rcn-title">Red Carpet Night 2026</h1>
      ...
      <section className="rcn-cards-section">
        <div className="rcn-cards-grid">
          ...
          <article className="rcn-card">
            <h2>Yearly Honors</h2>
            <p>
              The 2026 edition celebrates innovation, trust, and customer excellence across the CIO
              ecosystem.
            </p>
          </article>
          <article className="rcn-card">
