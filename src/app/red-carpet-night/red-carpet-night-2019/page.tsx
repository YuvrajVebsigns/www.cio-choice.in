...
export default function RedCarpetNight2019Page() {
  ...
  useEffect(() => {
    async function loadPage() {
      try {
        const data = await fetchWebsitePageBySlug('red-carpet-night-2019');
    ...
    <main className="rcn-main">
      <section className="rcn-hero">
        ...
        <div className="rcn-hero-content">
          ...
          <h1 className="rcn-title">{page?.title || 'Red Carpet Night 2019'}</h1>
