...
const content = {
  Overview: [
    '2021 set the stage for CORE Media’s strategic media presence with strong coverage in regional business press.',
...
export default function MediaCoverage2021Page() {
  const [activeTab, setActiveTab] = useState('Overview');

  return (
    <main className="page-container">
      <section className="page-header">
        <h1>Media Coverage - 2021</h1>
        <p>Interactive recap of CORE Media’s 2021 media coverage and press momentum.</p>
      </section>
