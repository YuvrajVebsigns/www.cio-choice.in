...
const content = {
  Overview: [
    '2024 set the stage for CORE Media’s strategic media presence with strong coverage in regional business press.',
...
export default function MediaCoverage2024Page() {
  const [activeTab, setActiveTab] = useState('Overview');

  return (
    <main className="page-container">
      <section className="page-header">
        <h1>Media Coverage - 2024</h1>
        <p>Interactive recap of CORE Media’s 2024 media coverage and press momentum.</p>
      </section>
