...
const content = {
  Overview: [
    '2023 set the stage for CORE Media’s strategic media presence with strong coverage in regional business press.',
...
export default function MediaCoverage2023Page() {
  const [activeTab, setActiveTab] = useState('Overview');

  return (
    <main className="page-container">
      <section className="page-header">
        <h1>Media Coverage - 2023</h1>
        <p>Interactive recap of CORE Media’s 2023 media coverage and press momentum.</p>
      </section>
