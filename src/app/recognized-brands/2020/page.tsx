...
export default function RecognizedBrands2020Page() {
  ...
  useEffect(() => {
    async function loadPage() {
      ...
      const data = await fetchWebsitePageBySlug('recognized-brands-2020');
    ...
    <main className="rcn-main">
      <section className="rcn-hero">
        ...
        <div className="rcn-hero-content">
          ...
          <h1 className="rcn-title">{page?.title || 'Recognized Brands 2020'}</h1>
