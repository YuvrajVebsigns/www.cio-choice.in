...
//       const data = await fetchWebsitePageBySlug('recognized-brands-2026');
...
//           <h1 className="rcn-title">{page?.title || 'Recognized Brands 2026'}</h1>
...
function extractItems(page: WebsitePage | null): BrandItem[] {
  ...
  function addItem(value: Record<string, unknown>) {
     ...
     */
    if (normalizedAuthor === pageTitle || normalizedAuthor === 'recognized brands 2026') {
      return;
    }
