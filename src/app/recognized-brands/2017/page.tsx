...
export default function RecognizedBrands2017Page() {
  ...
  useEffect(() => {
    async function loadPage() {
      ...
      const data = await fetchWebsitePageBySlug('recognized-brands-2017');
  ...
  return (
    <main className="rcn-main">
      <section className="rcn-hero rcn-hero-2017">
        <div className="rcn-hero-overlay" />

        <div className="rcn-hero-content">
          <span className="rcn-hero-badge">Red Carpet Night 2017</span>

          <h1 className="rcn-title">{page?.title || 'Recognized Brands 2017'}</h1>

          <p className="rcn-subtitle">
            Celebrating the most trusted ICT brands, technology leaders, and innovators recognized
            by CIO Choice in 2017.
          </p>
