...
//   const pdfUrl =
//     '/assets/yearbook/2018/CIO CHOICE 2018 Year Book.pdf';

//   const link = document.createElement('a');

//   link.href = pdfUrl;
//   link.download = 'CIO-Choice-2018-YearBook.pdf';
...
export default function SurveyStudyPage() {
  ...
  const handleYearbookDownload = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Replace this with the actual 2018 report ID
      const reportId = '6aa3be6c59fc0416cb734152';
      ...
      // console.error('CIO Choice 2018 Year Book download failed:', error);
