...
//   const pdfUrl =
//     '/assets/yearbook/2016/CIO-Choice-2016.pdf';

//   const link = document.createElement('a');

//   link.href = pdfUrl;
//   link.download = 'CIO-Choice-2016-YearBook.pdf';
...
//               <h2>CIO Choice 2016 Year Book</h2>

//               <p className="survey-study-intro">
//                 The <strong>CIO Choice 2016 Year Book</strong> showcases India&apos;s most trusted
...
//                     <h3>Year Book 2016</h3>

//                     <p>
//                       Enterprises honored with the prestigious CIO Choice 2016 Recognition are
...
//                       <strong>CIO Choice 2016 Coffee Table Book.</strong>
//                     </p>
//                   </div>
//                 </div>
//               </div>
...
export default function SurveyStudyPage() {
  ...
  const handleYearbookDownload = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      /*
       * Replace this with the actual 2016
       * report ID from your backend/CMS.
       */
      const reportId = '6aa3bef859fc0416cb734157';
      ...
      // console.error('CIO Choice 2016 Year Book download failed:', error);
  ...
  /*
   * Automatically finds all 2016 yearbook pages.
   *
   * Expected filenames:
   * page-001.jpg
   * page-002.jpg
  ...
  useEffect(() => {
    ...
    const loadYearbookPages = async () => {
      ...
      for (let pageNumber = 1; pageNumber <= MAX_PAGES; pageNumber++) {
        ...
        const imagePath = `/assets/yearbook/2016/page-${page}.jpg`;
              ...
              {currentPages.length > 0 ? (
                currentPages.map((page, index) => (
                  <div className="book-page" key={page}>
                    <img
                      src={page}
                      alt={`CIO Choice 2016 Year Book Page ${
                        currentSpread === 0 ? 1 : currentSpread * 2 + index
                      }`}
                    />
                  </div>
