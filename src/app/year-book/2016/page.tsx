...
export default function SurveyStudyPage() {
  ...
  /*
   * Generate all 2016 yearbook page paths directly.
   *
   * Expected filenames:
   * page-001.jpg
   * page-002.jpg
   ...
   * ...
   *
   * This avoids the old sequential Image() existence checks
   * that caused unnecessary network requests and slow loading.
   */
  useEffect(() => {
   ...
   * - Previous spread
   *
   * This keeps navigation fast without loading
   * the entire yearbook at once.
   */
  useEffect(() => {
