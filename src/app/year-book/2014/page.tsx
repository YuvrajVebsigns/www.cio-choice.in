...
//       /*
//        * IMPORTANT:
//        * Replace this with the actual 2014 report ID
//        * from your backend/CMS.
//        */
//       const reportId = '6aa3bf2059fc0416cb73415b';
...
//     } catch (error) {
//       // console.error('Yearbook download failed:', error);
...
//   /*
//    * Automatically finds all 2014 yearbook pages.
//    *
//    * Expected:
//    * /assets/yearbook/2014/page-01.jpg
//    * /assets/yearbook/2014/page-02.jpg
//    * /assets/yearbook/2014/page-03.jpg
//    * ...
//    */
//   useEffect(() => {
//     let cancelled = false;
...
//         const imagePath = `/assets/yearbook/2014/page-${page}.jpg`;
...
//               <h2>CIO Choice 2014 Year Book</h2>

//               <p className="survey-study-intro">
//                 The <strong>CIO Choice 2014 Year Book</strong> showcases India&apos;s most trusted
...
//                   <img
//                     src="/assets/yearbook/2014/page-01.jpg"
//                     alt="CIO Choice 2014 Year Book"
//                     className="survey-study-book-image"
//                   />

//                   <div className="survey-study-book-content">
//                     <h3>Year Book 2014</h3>

//                     <p>
//                       Enterprises honored with the prestigious CIO Choice 2014 Recognition are
...
//                       <strong>CIO Choice 2014 Coffee Table Book.</strong>
//                     </p>
//                   </div>
//                 </div>
//               </div>
...
//                     <img
//                       src={page}
//                       alt={`CIO Choice 2014 Year Book Page ${
...
2014 uses 2-digit page numbering:
page-01.jpg
page-02.jpg
page-03.jpg
...
...
Direct generation avoids the old sequential Image()

existence checks for up to 200 pages.
*/
  useEffect(() => {
...
Preload only the current, next, and previous spreads.
This keeps page navigation fast without loading every
yearbook image into memory immediately.
*/
  useEffect(() => {
