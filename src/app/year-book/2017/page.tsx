...
export default function SurveyStudyPage() {
  ...
  /*
   * Generate all 2017 yearbook page paths directly.
   *
   * Expected filenames:
   * page-001.jpg
   * page-002.jpg
   ...
   * which caused unnecessary network requests and slow page loading.
   */
  useEffect(() => {
   ...
   * - Previous spread
   *
   * This keeps navigation fast without loading the entire book
