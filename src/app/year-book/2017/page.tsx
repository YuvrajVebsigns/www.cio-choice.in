...
//   const pdfUrl =
//     '/assets/yearbook/2017/CIO-Choice-2017-YB_low.pdf';

//   const link = document.createElement('a');

//   link.href = pdfUrl;
//   link.download = 'CIO-Choice-2017-YearBook.pdf';
...
//         const imagePath = `/assets/yearbook/2017/page-0${page}.jpg`;
...
//                   <img
//                     src="/assets/yearbook/2017/page-001.jpg"
...
export default function SurveyStudyPage() {
  ...
  const handleYearbookDownload = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      /*
       * Replace this with the actual 2017 report ID
       * from your backend/CMS.
       */
      const reportId = '6aa3be9159fc0416cb734154';
      ...
      // Redirect to the PDF/download URL returned by the API.
      window.location.assign(downloadUrl);
    } catch (error) {
      // console.error('CIO Choice 2017 Year Book download failed:', error);
  ...
  /*
   * Automatically finds all 2017 yearbook pages.
   *
   * Expected filenames:
   * page-001.jpg
   * page-002.jpg
  ...
  useEffect(() => {
    ...
    const loadYearbookPages = async () => {
      ...
      for (let pageNumber = 1; pageNumber <= MAX_PAGES; pageNumber++) {
        ...
        const imagePath = `/assets/yearbook/2017/page-${page}.jpg`;
              ...
              {currentPages.length > 0 ? (
                currentPages.map((page, index) => (
                  <div className="book-page" key={page}>
                    <img
                      src={page}
                      alt={`CIO Choice 2017 Year Book Page ${
                        currentSpread === 0 ? 1 : currentSpread * 2 + index
                      }`}
                    />
                  </div>
