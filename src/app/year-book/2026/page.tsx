...
//         const imagePath = `/assets/yearbook/2026/page-${page}.jpg`;
...
//                   <img
//                     src="/assets/yearbook/2026/page-01.jpg"
...
export default function SurveyStudyPage() {
   ...
   *
   * IMPORTANT:
   * Set this to the actual number of JPG pages available in:
   *
   * /public/assets/yearbook/2026/
   *
   * Example:
   * page-01.jpg
   * page-02.jpg
   ...
   * page-40.jpg
   *
   * If your yearbook has 40 pages, use 40.
   */
   ...
   * - Request page 03
   * - ...
   * - Continue until a request fails
   *
   * This is slow on the live website because every request
   * waits for the previous request.
   *
   * NEW METHOD:
   *
   * Generate the known image paths immediately.
   *
   * No network request is made just to discover how many pages
   * exist.
   */
  useEffect(() => {
   ...
   * =========================================================
   *
   * Only a small number of pages are preloaded.
   *
                ...
                currentPages.map((page, index) => {
                  ...
                  return (
                    <div className="book-page" key={page}>
                      <img
                        src={page}
                        alt={`CIO Choice 2026 Year Book Page ${pageNumber}`}
