...
export default function SurveyStudyPage() {
   ...
   *
   * OPTIMIZED:
   * We no longer make sequential requests to discover pages.
   *
   * The page URLs are generated immediately.
   *
   * 2025 uses 3-digit filenames:
   *
   * page-001.jpg
   * page-002.jpg
   * page-003.jpg
   ...
   *
   * This avoids downloading the entire yearbook immediately.
   * ============================================================ */
                ...
                currentPages.map((page, index) => {
                  ...
                  return (
                    <div className="book-page" key={page}>
                      <img
                        src={page}
                        alt={`CIO Choice 2025 Year Book Page ${pageNumber}`}
