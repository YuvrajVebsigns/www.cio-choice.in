...
//   const pdfUrl =
//     '/assets/yearbook/2025/CIO CHOICE 2025 Year Book.pdf';

//   const link = document.createElement('a');

//   link.href = pdfUrl;
//   link.download = 'CIO-Choice-2025-YearBook.pdf';
...
//         const imagePath = `/assets/yearbook/2025/page-0${page}.jpg`;
...
export default function SurveyStudyPage() {
  ...
  /* ============================================================
   * YEAR BOOK DOWNLOAD - API INTEGRATION
   * ============================================================
   *
   * This uses the same website report download API as the
   * 2024 Year Book.
   *
   * API:
   * POST /api/v1/website/reports/download
   *
   * The API records the downloader details and returns
   * a generated download URL.
   *
   * IMPORTANT:
   * Replace the 2025 REPORT ID below with the actual
   * Report ID of "CIO Choice 2025 Year Book".
   */
  ...
  const handleYearbookDownload = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
       ...
       * IMPORTANT:
       *
       * Put the actual Report ID of:
       * CIO Choice 2025 Year Book
       *
       * Do NOT use the 2024 Report ID here.
       */
      const reportId = '6aa3aa6b2713e16de1cda212';
       ...
       * - 2025 Report ID
       *
       * The service returns the generated download URL.
       */
      ...
      /*
       * Redirect browser to the URL returned by the API.
       */
      window.location.assign(downloadUrl);
    } catch (error) {
      // console.error('Year Book 2025 download failed:', error);
