...
//         const imagePath = `/assets/yearbook/2023/page-${page}.jpg`;
...
//                   <img
//                     src="/assets/yearbook/2023/page-01.jpg"
...
export default function SurveyStudyPage() {
  ...
  /*
   * Generate all 2023 yearbook page paths immediately.
   *
   * This is much faster than checking each image one-by-one with
   * new Image() because the old implementation could make up to
   * 200 sequential requests before rendering the book.
   *
   * 2023 uses:
   *
   * /assets/yearbook/2023/page-01.jpg
   * /assets/yearbook/2023/page-02.jpg
   * /assets/yearbook/2023/page-03.jpg
   * ...
   */
  useEffect(() => {
   ...
   * - previous spread
   *
   * This avoids downloading every yearbook page immediately.
   */
  useEffect(() => {
              ...
              {currentPages.length > 0 ? (
                currentPages.map((page, index) => (
                  <div className="book-page" key={page}>
                    <img
                      src={page}
                      alt={`CIO Choice 2023 Year Book Page ${
                        currentSpread === 0 ? 1 : currentSpread * 2 + index
                      }`}
