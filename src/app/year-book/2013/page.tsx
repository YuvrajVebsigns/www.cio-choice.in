...
// //   const pdfUrl =
// //     '/assets/yearbook/2013/CIO-CHOICE-2013-Year-Book.pdf';

// //   const link = document.createElement('a');

// //   link.href = pdfUrl;
// //   link.download = 'CIO-Choice-2013-YearBook.pdf';
...
// //         const imagePath = `/assets/yearbook/2013/page-${page}.jpg`;
...
// //               <h2>CIO Choice 2013 Year Book</h2>

// //               <p className="survey-study-intro">
// //                 The <strong>CIO Choice 2013 Year Book</strong> showcases India&apos;s most trusted
...
// //                   <img
// //                     src="/assets/yearbook/2013/page-01.jpg"
// //                     alt="CIO Choice Year Book 2026"
// //                     className="survey-study-book-image"
// //                   />

// //                   <div className="survey-study-book-content">
// //                     <h3>Year Book 2013</h3>

// //                     <p>
// //                       Enterprises honored with the prestigious CIO Choice 2013 Recognition are
...
// //                       <strong>CIO Choice 2013 Coffee Table Book.</strong>
// //                     </p>
// //                   </div>
// //                 </div>
// //               </div>
...
//       /*
//        * Replace this with the actual 2013 report ID
...
//     } catch (error) {
//       // console.error('2013 Yearbook download failed:', error);

//       alert(
//         error instanceof Error
//           ? error.message
//           : 'Unable to download the yearbook. Please try again.',
//       );
//     } finally {
...
//   /*
//    * Automatically loads all 2013 yearbook pages.
//    *
//    * Expected:
//    * /assets/yearbook/2013/page-01.jpg
//    * /assets/yearbook/2013/page-02.jpg
//    * /assets/yearbook/2013/page-03.jpg
//    * ...
//    */
//   useEffect(() => {
//     let cancelled = false;
...
//                     <img
//                       src={page}
//                       alt={`CIO Choice 2013 Year Book Page ${
//                         currentSpread === 0 ? 1 : currentSpread * 2 + index
//                       }`}
//                     />
//                   </div>
...
export default function SurveyStudyPage() {
  ...
  /*
   * Generate all 2013 yearbook page paths directly.
   *
   * This avoids making up to 200 sequential image requests just to
  ...
  /*
   * Preload the current, next, and previous spreads.
   *
   * This keeps navigation smooth without loading every page
  ...
  useEffect(() => {
    ...
    currentPages.forEach((page) => pagesToPreload.add(page));

    const nextSpread = spreads[currentSpread + 1];

    if (nextSpread) {
      nextSpread.forEach((page) => pagesToPreload.add(page));
    }

    const previousSpread = spreads[currentSpread - 1];

    if (previousSpread) {
      previousSpread.forEach((page) => pagesToPreload.add(page));
    }
